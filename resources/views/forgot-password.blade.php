  ...
  <div class="container h-custom">
    ...
    <div class="row d-flex justify-content-center  ">
      ...
      <div class="login_box">
          ...
          @endif
      {{ Form::open(array('url' => 'forgotPassword_2', "method"=>"POST", 'autocomplete'=>"off")) }}
          ...
          <div class="form-outline mb-3">
            {!! Form::text('email',old('email'),[ "class"=>"form-control","id"=>"email","placeholder"=>"Email address","required"=>"required" ] ) !!}
            @error('email')
          ...
          <div class="text-center text-lg-start pt-2">
            {!! Form::submit("Submit",["class"=>"btn btn-lg w130"] ) !!}
            <p class="small mt-2 pt-1 mb-0">Don't have an account? <a href="{{ route('login') }}"class="link-danger">Login</a></p>
          </div>
