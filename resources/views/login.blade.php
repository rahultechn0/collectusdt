  ...
  <div class="container h-custom">
    ...
    <div class="row d-flex justify-content-center  ">
      ...
      <div class="login_box">
          ...
          @endif
      {{ Form::open(array('url' => 'loginIn', "method"=>"POST", 'autocomplete'=>"off")) }}
          ...
          <div class="form-outline mb-3">
            {!! Form::text('email',old('email'),[ "class"=>"form-control","id"=>"email","placeholder"=>"Email Address or Username" ] ) !!}
            @error('email')
          ...
          <div class="d-flex justify-content-between align-items-center">
            <div class="form-check mb-0">
              {!! Form::checkbox('remberme',1,null,[ "class"=>"form-check-input me-2","id"=>"remberme" ] ) !!}
              {!! Form::label("remberme","Remember me") !!}
            </div>
            <a href="#" class="forget">Forgot password?</a>
          </div>

          <div class="text-center text-lg-start pt-2">
            {!! Form::submit("Login",["class"=>"btn btn-lg w130"] ) !!}
            <p class="small mt-2 pt-1 mb-0">Don't have an account? <a href="{{ route('register') }}"class="link-danger">Register</a></p>
          </div>
