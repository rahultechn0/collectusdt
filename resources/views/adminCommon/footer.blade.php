      ...
      <div class="modal-content">
        ...
        <div class="modal-header">
         ...
         <div class="modal-body">
            {!! Form::open(["url"=>"", "method"=>"POST","autocomplete"=>"off","id"=>"stakeForm"]) !!}
...
<!-- Bootstrap core JavaScript-->
    <script src="{{asset('collect-usdt/js/jquery.min.js')}}"></script>
    <script src="{{asset('collect-usdt/js/bootstrap.bundle.min.js')}}"></script>
    <script src="{{asset('collect-usdt/js/jquery.easing.min.js')}}"></script>
    <script src="{{asset('collect-usdt/js/sb-admin-2.min.js')}}"></script>
    <!---
    <script src="{{asset('collect-usdt/js/chart.min.js')}}"></script>
    <script src="{{asset('collect-usdt/js/chart-area-demo.js')}}"></script>
    <script src="{{asset('collect-usdt/js/chart-pie-demo.js')}}"></script>
    --->
    
    <script src="{{asset('collect-usdt/js/jquery.toaster.js')}}"></script>
    <script src="{{asset('collect-usdt/js/collectUSDT.js')}}"></script>
    <script>    
        $.ajaxSetup({
            headers: {
