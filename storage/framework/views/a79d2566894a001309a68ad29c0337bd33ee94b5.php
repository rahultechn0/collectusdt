                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-end">
                                        <div class="col-12">
                                            ...
                                            <?php echo Form::open(["url"=>"saveaddress","autocomplete"=>"off","method"=>"POST"]); ?>                                   
                                            <div class="row deposit_d">
                                                ...
                                                <div class="col-12 col-md-5 mb-2">  
                                                    ...
                                                    <div class="select_d">                                     
                                                        ...
                                                        <?php $__currentLoopData = $currencyList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <div class="col-auto">
                                                    ...
                                                    <?php echo Form::input("submit","Save","Stake USDT", ["class"=>"btn  btn_d"]); ?>
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo number_format($totalIncome,2); ?> <small>USDT</small></div>
                                        </div>
                                        <div class="col-auto">
										<span class="d_icon" >
                                          <img src="<?php echo e(asset('html/img/usdt.png')); ?>" alt="Logo" >
                                        </span>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <h4 class="mb-30 fw600 mb-3">Active Package</h4>
                       ...
                       <div class="row ">
                        ...
                        <?php if(count($activePackages)>0){?>
                                <?php $__currentLoopData = $activePackages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key =>$active): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php 
                                            ...
                                            <div class="card-body">
                                                <div class="row no-gutters align-items-center">
                                                    <div class="col mr-2">
                                                        ...
                                                        <?php echo number_format($active['amount'],2); ?> <?php echo $active->currencyData->name; ?></div>
                                                        <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo number_format($roiAmt,2); ?> <small>USDT Dividend </small></div>
                                                    </div>
                                                    <div class="col-auto">
                                                    <span class="d_icon" >
                                                    <img src="<?php echo e(asset('html/img/'.$active->currencyData->image )); ?>" alt="Logo" >
                                                    </span>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                ...
                                                <input class="width-100" id="referral_link" value="<?php echo e(url('register/'.$userData['username'])); ?>" /> <i class="fa fa-copy" onClick="copyToClipboard('referral_link','Referral link Copied','referral_link_msg');" aria-hidden="true"></i>
                                    ...
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                ...
                                                <input class="width-100" id="referral_code" value="<?php echo $userData['username'];?>" /> <i class="fa fa-copy" onClick="copyToClipboard('referral_code','Referral code Copied','referral_code_msg');" aria-hidden="true"></i>
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class=" fw500 mb-1">
                                                Referral Income</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo number_format($referralIncome,2); ?> <small>USDT</small></div>
                                        </div>
                                        <div class="col-auto">
										<span class="d_icon" >
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class=" fw500 mb-1">
                                                Level Income</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo number_format($levelIncome,2); ?> <small>USDT</small></div>
                                        </div>
                                        <div class="col-auto">
										<span class="d_icon" >
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class=" fw500 mb-1">
                                                Rank Bonus</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo number_format($rankIncome,2); ?> <small>USDT</small></div>
                                        </div>
                                        <div class="col-auto">
										<span class="d_icon" >
...
<?php echo $__env->make('adminCommon.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/techno/collectusdt/resources/views/dashboard.blade.php ENDPATH**/ ?>