    ...
    <div class="heading ">
        ...
        <div class="card shadow cardtable">
               ...
               <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $walletArr; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$wallet): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td><?php echo $key+1; ?></td>
                                <td><img src="<?php echo e(asset('html/img/'.$wallet['c_image'])); ?>"><?php echo e($wallet['c_name']); ?></td>
                                <td><?php echo number_format( ( $wallet['roi']+$wallet['level']+$wallet['referral']-$wallet['Withdrawal']-$wallet['fees']),6);?> USDT</td>
...
<?php echo $__env->make('adminCommon.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/techno/collectusdt/resources/views/wallet.blade.php ENDPATH**/ ?>